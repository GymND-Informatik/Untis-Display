...
$jscomp.findInternal = function (d, f, g) {
    ...
    for (var h = d.length, k = 0; k < h; k++) {
        var m = d[k];
        if (f.call(g, m, k, d)) return {i: k, v: m}
    }
    return {i: -1, v: void 0}
};
$jscomp.ASSUME_ES5 = !1;
...
$jscomp.polyfillUnisolated = function (d, f, g, h) {
    ...
    h = g[d];
    f = f(h);
    f != h && null != f && $jscomp.defineProperty(g, d, {configurable: !0, writable: !0, value: f})
};
...
(function (d) {
    ...
    d.extend(m.prototype, {
        measure: function (a) {
            ...
            var c = this, e = !1, l = this.rowToPixels(a), n = a - (this.s.displayBuffer - 1) / 2 * this.s.viewportRows;
            0 > n && (n = 0);
            ...
            b === h || b ? (this.s.ani = e, d(this.dom.scroller).animate({scrollTop: l}, function () {
                setTimeout(function () {
                    c.s.ani = !1
                }, 250)
        ...
        _calcRowHeight: function () {
            var a = this.s.dt, b = a.nTable, c = b.cloneNode(!1), e = d("<tbody/>").appendTo(c),
            ...
            var n = d("tr", e).length;
            if (1 === n) e.prepend("<tr><td>&#160;</td></tr>"), e.append("<tr><td>&#160;</td></tr>"); else for (; 3 > n; n++) e.append("<tr><td>&#160;</td></tr>");
            ...
            var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop, e = d(this.s.dt.nTable).height(),
                l = this.s.dt._iDisplayStart, n = this.s.dt._iDisplayLength, p = this.s.dt.fnRecordsDisplay();
            this.s.skip = !0;
            ...
            if (this.s.dt.oFeatures.bInfo) {
                var a = this.s.dt, b = a.oLanguage, c = this.dom.scroller.scrollTop,
                    e = Math.floor(this.pixelsToRow(c, !1, this.s.ani) + 1), l = a.fnRecordsTotal(),
                    n = a.fnRecordsDisplay();
                c = Math.ceil(this.pixelsToRow(c +
                    this.s.heights.viewport, !1, this.s.ani));
                c = n < c ? n : c;
                var p = a.fnFormatNumber(e), r = a.fnFormatNumber(c), t = a.fnFormatNumber(l), u = a.fnFormatNumber(n);
                ...
                e = a.aanFeatures.i;
                if ("undefined" != typeof e) for (l = 0, n = e.length; l < n; l++) d(e[l]).html(p);
            ...
            var a = this, b = this.s.heights, c = this.dom.scroller.scrollTop;
            if (!this.s.skip && !this.s.ingnoreScroll && c !== this.s.lastScrollTop) if (this.s.dt.bFiltered || this.s.dt.bSorted) this.s.lastScrollTop = 0; else {
                this._info();
                ...
                if (this.s.forceReposition || c < this.s.redrawTop || c > this.s.redrawBottom) {
                    ...
                    }, this.s.dt.oFeatures.bServerSide ? (this.s.forceReposition = !0, clearTimeout(this.s.drawTO), this.s.drawTO = setTimeout(e, this.s.serverWait)) : e(), this.dom.loader && !this.s.loaderVisible && (this.dom.loader.css("display", "block"), this.s.loaderVisible =
                        !0))
    ...
    m.defaults = {boundaryScale: .5, displayBuffer: 9, loadingIndicator: !1, rowHeight: "auto", serverWait: 200};
